...
["MSG"] = "Has consumed ", -- Message to display when consumed
...
["MinTemperature"] = -100, -- -20°C From this temperature below, you'll lose more food and water
["MaxTemperature"] = 100, -- 20°C From this temperature avobe, you'll lose more food and water
...
Config.ItemsToUse = {		
    ...
    --
    {
        ...
        ["DisplayName"] = "Apple", -- Name on screen (label from DB)
    ...
    },
    {
        ...
        ["DisplayName"] = "Water", 				-- Name on screen (label from DB)
        ["Hunger"] = 0, 					--0-100%-- Food it gives
        ["Thirst"] = 50, 					--0-100%-- Water it gives
        ["InnerCoreStamina"] = 0, 		--0-100%-- Inner Core Stamina effect
        ["InnerCoreStaminaGold"] = 0.0, 	--0-100%-- Inner Core Stamina Gold overpower
        ["OuterCoreStaminaGold"] = 0.0, 	--0-100%-- Outer Core Stamina Gold overpower
        ["InnerCoreHealth"] = 0, 		--0-100%-- Inner Core Health effect
        ["InnerCoreHealthGold"] = 0.0, 	--0-100%-- Inner Core Health Gold overpower
        ["OuterCoreHealthGold"] = 0.0, 	--0-100%-- Outer Core Health Gold overpower
    },
    --
    -- MEDICINES
    --
    {
        ["Name"] = "bandage", -- DB NAME
        ["DisplayName"] = "bandage", 
        ["Hunger"] = 5,
        ["Thirst"] = 5,
        ["InnerCoreStamina"] = 0,
